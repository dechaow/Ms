...
public class NewsDetailsBean implements Parcelable {
    ...
    protected NewsDetailsBean(Parcel in) {
    ...
    public static final Parcelable.Creator<NewsDetailsBean> CREATOR = new Parcelable.Creator<NewsDetailsBean>() {
        @Override
        public NewsDetailsBean createFromParcel(Parcel source) {
            return new NewsDetailsBean(source);
        }

        @Override
        public NewsDetailsBean[] newArray(int size) {
            return new NewsDetailsBean[size];
        }
    };
}
