...
import com.example.wdc.ui.activity.picker.CommonImagePickerListActivity;
import com.example.wdc.ui.activity.qrcode.camera.CameraManager;
...
import com.example.wdc.ui.activity.qrcode.utils.BeepManager;
import com.example.wdc.ui.activity.qrcode.utils.InactivityTimer;
...
public class CaptureActivity extends BaseAppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected SurfaceView capturePreview;
    @BindView(R.id.capture_error_mask)
    protected ImageView captureErrorMask;
    @BindView(R.id.capture_scan_mask)
    protected ImageView captureScanMask;
    @BindView(R.id.capture_crop_view)
    protected FrameLayout captureCropView;
    @BindView(R.id.capture_picture_btn)
    protected Button capturePictureBtn;
    @BindView(R.id.capture_light_btn)
    protected Button captureLightBtn;
    @BindView(R.id.capture_mode_group)
    protected RadioGroup captureModeGroup;
    ...
    private void initCropViewAnimator() {
        mQrcodeCropWidth = DensityUtil.dip2px(this,200);
        mQrcodeCropHeight = DensityUtil.dip2px(this,200);

        mBarcodeCropWidth = DensityUtil.dip2px(this,260);
...
//            initCamera(holder);
    ...
    private void displayFrameworkBugMessageAndExit() {
        ...
        // TODO: 2016/7/27 将MaterialDialog 改成了 AlertDialog
        final AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setTitle(R.string.app_name).setMessage("打开相机失败,请确保允许应用使用相机权限后重试!").setNegativeButton("确定", new DialogInterface.OnClickListener() {
                @Override
